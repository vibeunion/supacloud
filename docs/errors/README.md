...
| [SC2012](SC2012.md) | `runtime-injection-disallowed` | compiler |
...
| [SC3021](SC3021.md) | `invalid-route-response-selector` | compiler |
| [SC3022](SC3022.md) | `conflicting-route-response-schema` | compiler |
| [SC3023](SC3023.md) | `duplicate-route-response-selector` | compiler |
| [SC3024](SC3024.md) | `invalid-route-response-map` | compiler |
| [SC3025](SC3025.md) | `route-contract-required` | compiler |
| [SC3026](SC3026.md) | `route-contract-unverified` | compiler |
| [SC3027](SC3027.md) | `route-contract-evidence-required` | compiler |
...
| [SC6007](SC6007.md) | `sql-result-assertion` | type-safety |
| [SC6008](SC6008.md) | `sql-raw-dynamic` | type-safety |
