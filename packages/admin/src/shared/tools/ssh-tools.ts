...
Actions: ping, setup, install, upgrade, upgrade_status, versions, diagnose, exec, troubleshoot, container_logs, backup_cleanup_plan, backup_cleanup_apply, tenant_manage, tenant_list, tenant_inspect, tenant_diagnose, tenant_migrate`,
        {
            ...
            edge_max_body_size_mb: optional(Type.Integer({ minimum: 1, maximum: 10240 }), "[install] Max Edge Runtime upload / request body size in MB (default: 30)"),
            ...
            switch (action) {
                ...
                case "install": {
                    ...
                    const envLines = [
                        ...
                        args.edge_max_body_size_mb ? `EDGE_MAX_BODY_SIZE_MB=${quoteEnvValue(String(args.edge_max_body_size_mb))}` : "",
