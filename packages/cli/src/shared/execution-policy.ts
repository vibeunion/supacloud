...
const ACTION_POLICY: Record<string, ModulePolicy> = {
    ...
    database: {
        read: ["list_tables", "describe_columns", "list_indexes", "list_constraints", "list_extensions", "extension_catalog", "rls_status", "rls_policies", "list_auth_users", "get_auth_user", "connections", "stats", "slow_queries", "list_migrations", "migration_inventory", "project_url", "generate_types", "database_lint", "db_lint", "rpc_catalog", "list_rpcs"],
    ...
    app: { local: ["init", "generate", "compile", "check", "graph", "explain", "export-tools"] },
