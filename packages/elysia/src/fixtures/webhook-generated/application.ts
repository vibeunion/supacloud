...
import { WebhookHeadersSchema, WebhookInputSchema, WebhookKeySchema, WebhookLookupSchema, WebhookReceiptSchema } from "../webhook/contracts";
  ...
  return [
    {
      ...
      controllers: [
      {
        ...
        scope: "request",
        routes: [{ method: "POST", path: "/update", handler: "update", body: WebhookInputSchema, headers: WebhookHeadersSchema, response: WebhookReceiptSchema, invoker: async (ctrl: unknown, req: { params?: Record<string, unknown>; query?: Record<string, unknown>; body?: unknown; headers?: Record<string, unknown>; cookie?: Record<string, unknown>; context?: unknown }) => { if (!isRecord(ctrl)) throw new TypeError("Route controller is not an object"); const handler = ctrl["update"]; if (typeof handler !== "function") throw new TypeError("Route handler update is not callable"); return await Reflect.apply(handler, ctrl, [req.body, req.headers?.["idempotency-key"]]); }, schemaKinds: {"body":"declared","headers":"declared","response":"declared"} }, { method: "GET", path: "/receipts/:key", handler: "receipt", params: WebhookKeySchema, response: WebhookLookupSchema, invoker: async (ctrl: unknown, req: { params?: Record<string, unknown>; query?: Record<string, unknown>; body?: unknown; headers?: Record<string, unknown>; cookie?: Record<string, unknown>; context?: unknown }) => { if (!isRecord(ctrl)) throw new TypeError("Route controller is not an object"); const handler = ctrl["receipt"]; if (typeof handler !== "function") throw new TypeError("Route handler receipt is not callable"); return await Reflect.apply(handler, ctrl, [(req.params?.["key"] !== undefined ? req.params?.["key"] : undefined)]); }, schemaKinds: {"params":"declared","response":"declared"} }],
      }
    ],
