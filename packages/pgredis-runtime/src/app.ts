  ...
  return new Elysia({ normalize: false })
    ...
    .get("/internal/v1/admin/metrics", ({ request, set }) => {
      ...
      return renderPgredisMetrics({
        ...
        l1NegativeHits: snapshot.l1.negativeHits,
        l1InflightReads: snapshot.l1.inflightReads,
        l1CoalescedReads: snapshot.l1.coalescedReads,
        l1Bytes: snapshot.l1.bytes,
        l1PausedTenants: snapshot.l1.pausedTenants,
